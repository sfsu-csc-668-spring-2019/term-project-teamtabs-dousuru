...
/organization/id/:organizationId/project/create
/organization/id/:organizationId/project/id/:projectId
/organization/id/:organizationId/project/id/:projectId/chatlog
/organization/id/:organizationId/project/id/:projectId/configuration
/organization/id/:organizationId/project/id/:projectId/notification


/organization/id/:organizationId/project/create
/organization/id/:organizationId/project/id/:projectId/chatlog
/organization/id/:organizationId/project/id/:projectId/chatlog/search
/organization/id/:organizationId/project/id/:projectId/configuration
/organization/id/:organizationId/project/id/:projectId/delete
/organization/id/:organizationId/project/id/:projectId/notification
/organization/id/:organizationId/project/id/:projectId/search
