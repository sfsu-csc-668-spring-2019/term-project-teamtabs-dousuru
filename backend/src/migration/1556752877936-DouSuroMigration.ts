...
export class DouSuroMigration1556752877936 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "task" ("id" SERIAL NOT NULL, "name" character varying(60) NOT NULL, "description" character varying(5000) NOT NULL, "startTime" TIMESTAMP NOT NULL, "endTime" TIMESTAMP NOT NULL, "dueDate" TIMESTAMP NOT NULL, "baseListId" integer, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "list" ("id" SERIAL NOT NULL, "name" character varying(60) NOT NULL, "description" character varying(5000) NOT NULL, "baseProjectId" integer, CONSTRAINT "PK_d8feafd203525d5f9c37b3ed3b9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "project" ("id" SERIAL NOT NULL, "name" character varying(60) NOT NULL, "description" character varying(5000) NOT NULL, "isPublic" boolean NOT NULL, "ownerId" integer, "baseOrganizationId" integer, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "organization" ("id" SERIAL NOT NULL, "name" character varying(60) NOT NULL, "description" character varying(5000) NOT NULL, "icon" character varying(2083) NOT NULL, "ownerId" integer, CONSTRAINT "PK_472c1f99a32def1b0abb219cd67" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "userName" character varying(40) NOT NULL, "password" character varying(100) NOT NULL, "displayName" character varying NOT NULL, "email" character varying(200) NOT NULL, "icon" character varying(2083) NOT NULL, CONSTRAINT "UQ_da5934070b5f2726ebfd3122c80" UNIQUE ("userName"), CONSTRAINT "UQ_638bac731294171648258260ff2" UNIQUE ("password"), CONSTRAINT "UQ_059e69c318702e93998f26d1528" UNIQUE ("displayName"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "message_partition" ("id" SERIAL NOT NULL, "index" integer NOT NULL, "displayedValue" character varying NOT NULL, "type" character varying NOT NULL, "url" character varying NOT NULL, CONSTRAINT "PK_e9a5e545abf46c3778bf4dacd39" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tag" ADD CONSTRAINT "FK_adb5c1c902da883288b6dcb023f" FOREIGN KEY ("baseTaskId") REFERENCES "task"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "task" ADD CONSTRAINT "FK_941bf6d26ce243880b69b0fd3b3" FOREIGN KEY ("baseListId") REFERENCES "list"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "list" ADD CONSTRAINT "FK_eb435281befdcd4395e3106b44f" FOREIGN KEY ("baseProjectId") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "role" ADD CONSTRAINT "FK_a1fb224502f5f78de30c7af7888" FOREIGN KEY ("projectId") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "message" ADD CONSTRAINT "FK_79308bc7b73d3190a973655411d" FOREIGN KEY ("baseProjectId") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "message" ADD CONSTRAINT "FK_44c188867ace9f8347f11d3b7e5" FOREIGN KEY ("baseOrganizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "project" ADD CONSTRAINT "FK_3dbcf27d6bb07da664c28231460" FOREIGN KEY ("baseOrganizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
